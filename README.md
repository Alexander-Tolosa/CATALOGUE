...
-  **Voice & Text Translator**: Real-time translation with phonetic breakdown and instant flashcard saving.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/your-username/CATalogue.git
   cd CATalogue
   ```
