...
export const KOREAN_FOUNDATIONS = {
  ...
  consonants: [
    ...
    { char: 'ㅅ', name: 'Siot', sound: 's/t', strokeGuide: "Inverted V shape" },
    // Row 2
    { char: 'ㅇ', name: 'Ieung', sound: 'ng', strokeGuide: "Counter-clockwise circle" },
    { char: 'ㅈ', name: 'Jieut', sound: 'j/t', strokeGuide: "Top bar over inverted V" },
    { char: 'ㄲ', name: 'Ssang-giyeok', sound: 'kk/k', strokeGuide: "Double Giyeok" },
    { char: 'ㄸ', name: 'Ssang-digeut', sound: 'tt', strokeGuide: "Double Digeut" },
    { char: 'ㅃ', name: 'Ssang-bieup', sound: 'pp', strokeGuide: "Double Bieup" },
    { char: 'ㅆ', name: 'Ssang-siot', sound: 'ss/t', strokeGuide: "Double Siot" },
    { char: 'ㅉ', name: 'Ssang-jieut', sound: 'jj', strokeGuide: "Double Jieut" },
    // Row 3
    { char: 'ㅋ', name: 'Kieuk', sound: 'k/k', strokeGuide: "Giyeok with middle horizontal bar" },
    { char: 'ㅌ', name: 'Tieut', sound: 't/t', strokeGuide: "Digeut with middle horizontal bar" },
    { char: 'ㅍ', name: 'Pieup', sound: 'p/p', strokeGuide: "Top/bottom bars with two vertical lines" },
    { char: 'ㅊ', name: 'Chieut', sound: 'ch/t', strokeGuide: "Top dot over Jieut" },
